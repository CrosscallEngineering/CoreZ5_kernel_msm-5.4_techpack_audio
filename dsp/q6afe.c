...
#define AFE_PORT_ID_AWDSP_RX             (AFE_PORT_ID_RX_CODEC_DMA_RX_1)
#define AFE_PORT_ID_AWDSP_TX             (AFE_PORT_ID_TX_CODEC_DMA_TX_1)
...
/*hmct added, begin*/
#ifdef CONFIG_SND_SOC_AWINIC_AW87XXX
	pr_debug("%s: running in awinic dsp coummunication\n",__func__);
